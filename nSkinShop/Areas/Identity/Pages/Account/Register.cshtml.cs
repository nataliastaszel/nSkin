...
namespace nSkinShop.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [ValidateNever] public IEnumerable<SelectListItem> RolesList { get; set; }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new()
            {
                RolesList = _roleManager.Roles.Select(role => role.Name).Select(role => new SelectListItem
                {
                    Text = role,
                    Value = role
                }),
